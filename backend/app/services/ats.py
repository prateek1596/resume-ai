...
from app.models.resume import ResumeData, ATSAnalysis, ATSSuggestion
...
async def analyze(resume: ResumeData, job_description: str = "") -> ATSAnalysis:
    ...
    if client is None:
      return ATSAnalysis(
        score=70,
        breakdown={"keywords": 70, "formatting": 75, "content_quality": 70, "quantification": 65, "completeness": 70},
        suggestions=[
          ATSSuggestion(type="improve", category="content", text="Add role-specific achievements with measurable impact.", priority="high"),
          ATSSuggestion(type="add", category="keywords", text="Include keywords from the target job description.", priority="high"),
        ],
        matched_keywords=[],
        missing_keywords=[],
      )
    ...
    try:
      ...
      return ATSAnalysis(
        ...
        breakdown={"keywords": 70, "formatting": 75, "content_quality": 70, "quantification": 65, "completeness": 70},
        suggestions=[
          ATSSuggestion(type="improve", category="content", text="Strengthen bullets with action verbs and outcomes.", priority="high"),
          ATSSuggestion(type="add", category="keywords", text="Align skills and summary with the target role.", priority="high"),
        ],
        matched_keywords=[],
        missing_keywords=[],
      )
